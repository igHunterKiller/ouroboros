...
// or our code
inline float3x3 rotateHLSL( float radians, const float3 unitVec)
{
...
inline float3x3 rotateHLSL(const float3 _NormalizedSrcVec, const float3 _NormalizedDstVec)
{
