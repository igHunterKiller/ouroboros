// When and where Microsoft ships this header is confusing, so here it is, where
// we can find it.
...
#include "oaidl.h"
#include "ocidl.h"
//@OOOii-Kevin: Hacking d3ddependency
//#include "dxtrans.h"
class IDXEffect
{
...
// @OOOii-Kevin: Disable stoopid message this is hacked up already
