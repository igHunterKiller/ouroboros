...
bool from_string(float2* out_value, const char* src)
{
	return from_string_float_array((float*)out_value, 2, src);
}

bool from_string(float3* out_value, const char* src)
{
	return from_string_float_array((float*)out_value, 3, src);
}

bool from_string(float4* out_value, const char* src)
{
	return from_string_float_array((float*)out_value, 4, src);
}

bool from_string(float4x4* out_value, const char* src)
{
...
bool from_string(double4x4* out_value, const char* src)
{
	// Read in-order, then transpose
...
bool from_string(int2* out_value, const char* src) { CHK_MV(); return 2 == sscanf_s(src, "%d %d", &out_value->x, &out_value->y); }
bool from_string(int3* out_value, const char* src) { CHK_MV(); return 3 == sscanf_s(src, "%d %d %d", &out_value->x, &out_value->y, &out_value->z); }
bool from_string(int4* out_value, const char* src) { CHK_MV(); return 4 == sscanf_s(src, "%d %d %d %d", &out_value->x, &out_value->y, &out_value->z, &out_value->w); }
bool from_string(uint2* out_value, const char* src) { CHK_MV_U(); return 2 == sscanf_s(src, "%u %u", &out_value->x, &out_value->y); }
bool from_string(uint3* out_value, const char* src) { CHK_MV_U(); return 3 == sscanf_s(src, "%u %u %u", &out_value->x, &out_value->y, &out_value->z); }
bool from_string(uint4* out_value, const char* src) { CHK_MV(); return 4 == sscanf_s(src, "%u %u %u %u", &out_value->x, &out_value->y, &out_value->z, &out_value->w); }
