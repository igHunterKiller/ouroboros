...
struct ouro_jpeg_memory_alloc {
  ...
  JMETHOD(void*, get_large, (j_common_ptr cinfo, size_t sizeofobject));
  JMETHOD(void, free_large, (j_common_ptr cinfo, void FAR* object, size_t sizeofobject));
  JMETHOD(size_t, mem_available, (j_common_ptr cinfo, size_t min_bytes_needed,
	  size_t max_bytes_needed, size_t already_allocated));
  JMETHOD(long, init, (j_common_ptr cinfo));
  JMETHOD(void, term, (j_common_ptr cinfo));
};
...
#define oooii_jpeg_std_alloc		oooii_jStdError
